...
import com.example.demo1.Adapter.DialogEditAdapter;
import com.example.demo1.Adapter.DokterDialogEditAdapter;
import com.example.demo1.Adapter.PenggunaDialogEditAdapter;
...
public class AkunController {
    ...
    private DialogEditAdapter dialogAdapter;
        ...
        colAksi.setCellFactory(col -> new TableCell<>() {
...

            {
                ...
                btnHapus.setOnAction(event -> {
                    ...
                    alert.setContentText("Pengguna: " + pengguna.getNama());
    ...
    private void tampilkanDialogTambah() {
        ...
        keahlianField.setPromptText("Default kosong");
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == simpanButtonType) {
                try {
                    ...
                    String peran = peranCombo.getValue();
    ...
    private void tampilkanDialogEdit(Pengguna pengguna) {
        if(pengguna instanceof Dokter){
            dialogAdapter = new DokterDialogEditAdapter();
            dialogAdapter.tampilkanDialogEdit(pengguna, tableUser);
        }else{
            dialogAdapter = new PenggunaDialogEditAdapter();
            dialogAdapter.tampilkanDialogEdit(pengguna, tableUser);
        }
    }
}
